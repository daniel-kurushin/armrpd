...
COPY rpd (id, name, version, comment, pathpdf, pathfos, dateofreport, reportnumber, arguesperson, headofuop, discipline, faculty, leaddepartment, program, directionofpreparation, profile, qualification, graduatedepartment, modeofstudy, course, creditsze, totalhourse, year, dateofapprovalrup, ordernumberfgos, dateofapprovalfgos, partofthetrainingcycle, typeofthetrainingcycle, jsonrpd) FROM stdin;
\.
